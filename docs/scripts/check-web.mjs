...
try{
 ...
 await page.getByRole('button',{name:'Ocultar índice'}).click();assert(await page.locator('#sidebar').isHidden());
 await page.getByRole('button',{name:'Mostrar índice'}).click();assert(await page.locator('#sidebar').isVisible());
 ...
 await page.goto('http://localhost:3000/src/#caja');await page.getByRole('button',{name:'Mostrar índice'}).click();assert(await page.locator('#sidebar').isVisible());await page.keyboard.press('Escape');assert(await page.locator('#sidebar').isHidden());
