...
/* Las presentaciones de grupo se llaman igual que su grupo; en la ayuda web reciben un título propio para no repetir el encabezado del índice. */
const webTitles={'grupo-servicio':'Servicio: primeros pasos','grupo-operacion':'Operación diaria: primeros pasos','grupo-gestion':'Gestión: primeros pasos'};
const titleOf=p=>webTitles[p.id]||p.title;
